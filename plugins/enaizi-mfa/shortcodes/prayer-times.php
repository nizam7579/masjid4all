...
function niz_mfa_prayer_times_shortcode() {
    ...
    // Output the static HTML shell. No API calls or cookie checks in PHP.
    ob_start();
    ?>
    <div id="<?php echo esc_attr($instance_id); ?>" 
        ...
        <!-- Next Prayer Active Countdown Panel -->
...
// ------------------------------------------------------------------
// Live Location Shortcode (Already Client-Side)
// ------------------------------------------------------------------
