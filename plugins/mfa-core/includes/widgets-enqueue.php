...
function mfa_core_enqueue_widget_assets() {
	...
	if ( $is_tool_page ) {
		$css = MFA_CORE_PATH . 'assets/css/tool-page-v3.css';
		wp_enqueue_style( 'mfa-core-tool-page', MFA_CORE_URL . 'assets/css/tool-page-v3.css', array(), $get_version( $css ) );
	}

	$is_brand_page = $post && in_array( $post->post_name, array( 'about-us', 'contact-us' ), true );
	if ( $is_brand_page ) {
		$header_css = MFA_CORE_PATH . 'assets/css/tool-page-v3.css';
		wp_enqueue_style( 'mfa-core-tool-page', MFA_CORE_URL . 'assets/css/tool-page-v3.css', array(), $get_version( $header_css ) );
...
function mfa_core_litespeed_css_excludes( $excludes ) {
	...
	$excludes[] = 'mfa-core/assets/css/tool-page-v3.css';
