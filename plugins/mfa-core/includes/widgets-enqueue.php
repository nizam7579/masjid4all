...
function mfa_core_enqueue_widget_assets() {
	...
	$header_css_path = MFA_CORE_PATH . 'assets/css/header-v2.css';
	$header_js_path  = MFA_CORE_PATH . 'assets/js/header-v1.js';
	wp_enqueue_style( 'mfa-core-header', MFA_CORE_URL . 'assets/css/header-v2.css', array(), $get_version( $header_css_path ) );
	wp_enqueue_script( 'mfa-core-header', MFA_CORE_URL . 'assets/js/header-v1.js', array(), $get_version( $header_js_path ), true );
...
function mfa_core_litespeed_css_excludes( $excludes ) {
	...
	$excludes[] = 'mfa-core/assets/css/header-v2.css';
	return $excludes;
}
