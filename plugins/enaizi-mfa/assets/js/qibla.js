...
(function() {
    ...
    // Helper to read cookies safely (Same as prayer-times.js)
    ...
    class QiblaFinder {
        constructor(scope) {
            ...
            // Throttle variables for UI repaints
        ...
        updateArrow() {
            ...
            // High performance rotation transform
            ...
            if (this.userLat !== null && this.userLng !== null) {
                ...
                if (this.statusBox) {
                    if (deviation < 4) {
                        ...
                        // Throttled UI update to prevent repainting text at 60fps and lag
        ...
        async startCompassPipeline() {
            ...
            if (!result) {
                // Switch to manual mode gracefully
                console.log('[MFA] Switching to manual rotation mode');
                ...
                console.log('[MFA] Auto-rotation active');
                if (this.statusBox) {
        ...
        fetchDeviceCoordinates() {
            return new Promise((resolve) => {
                ...
                // Default if no cookies (Kuala Lumpur)
                this.userLat = 3.14;
                this.userLng = 101.69;
                resolve();
            });
