...
function mfa_core_enqueue_widget_assets() {
	...
	$share_btn_css = MFA_CORE_PATH . 'assets/css/share-button-v9.css';
	$share_btn_js  = MFA_CORE_PATH . 'assets/js/share-button-v2.js';
	wp_enqueue_style( 'mfa-core-share-button', MFA_CORE_URL . 'assets/css/share-button-v9.css', array(), $get_version( $share_btn_css ) );
	wp_enqueue_script( 'mfa-core-share-button', MFA_CORE_URL . 'assets/js/share-button-v2.js', array(), $get_version( $share_btn_js ), true );
...
function mfa_core_litespeed_css_excludes( $excludes ) {
	...
	$excludes[] = 'mfa-core/assets/css/share-button-v9.css';
	return $excludes;
}